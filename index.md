...
- N‑linked glycosylation sites- count number of sites (sugars shield the surface; **more = harder to reach the surface**)
...
5. **Binder length range** you'll request (e.g. 55–120 aa): note your choice 
